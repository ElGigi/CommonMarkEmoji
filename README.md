...
[![Build Status](https://img.shields.io/github/workflow/status/ElGigi/CommonMarkEmoji/Tests/1.x.svg?style=flat-square)](https://github.com/ElGigi/CommonMarkEmoji/actions/workflows/tests.yml?query=branch%3A1.x)
